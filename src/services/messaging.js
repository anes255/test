...
const defaultTemplates = {
  en: {
    ...
    ready: "Hi {customer_name}! Your order #{order_number} is ready and will be shipped soon. Stay tuned!",
  ...
  fr: {
    ...
    ready: "Bonjour {customer_name}! Votre commande #{order_number} est prete et sera expediee bientot.",
